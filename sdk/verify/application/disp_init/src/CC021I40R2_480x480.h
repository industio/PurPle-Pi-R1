...
{
    "CC021I40R_480x480", // const char *m_pPanelName;                ///<  PanelName
  ...
  /*
    ...
    */
    ...
    E_MI_PNL_TI_6BIT_MODE,  //MHAL_DISP_ApiPnlTiBitMode_e m_ucTiBitMode;                         ///< MOD_4B[1:0], refer to "LVDS output app note"
    E_MI_PNL_OUTPUT_6BIT_MODE,  //MHAL_DISP_ApiPnlOutPutFormatBitMode_e m_ucOutputFormatBitMode;
