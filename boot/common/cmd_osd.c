...
U16 _getPanelWidth(void)
{
	return 1024;
}
U16 _getPanelHeight(void)
{
	return 600;
}
...
void DrawProgressBar(U32 u32X, U32 u32Y, U32 u32Percentage, U8 u8Style)
{
    ...
    printf("in cmd_osd.c, PROGRESS_BAR_HEIGHT = %d, _getPanelWidth()=%d, _getPanelHeight()=%d\n", PROGRESS_BAR_HEIGHT, _getPanelWidth(), _getPanelHeight());
