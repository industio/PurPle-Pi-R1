#ifndef PNL_TABLE_CC0702I50R
#define PNL_TABLE_CC0702I50R
MhalPnlParamConfig_t stPanel_CC0702I50R_1024x600 =
{
    ...
    ///////////////////////////////////////////////
    // sync related
    100,  //MS_U8 m_ucPanelHSyncWidth;               ///<  VOP_01[7:0], PANEL_HSYNC_WIDTH
    110,  //MS_U8 m_ucPanelHSyncBackPorch;           ///<  PANEL_HSYNC_BACK_PORCH, no register setting, provide value for query only
    ...
    15,  //MS_U8 m_ucPanelVBackPorch;               ///<  define PANEL_VSYNC_BACK_PORCH

    // DE related
    210,  //MS_U16 m_wPanelHStart;                   ///<  VOP_04[11:0], PANEL_HSTART, DE H Start (PANEL_HSYNC_WIDTH + PANEL_HSYNC_BACK_PORCH)
...
MhalPnlMipiDsiConfig_t stMipiDsiConfig_stPanel_CC0702I50R_1024x600 =
{
